...
\pnum
Iterators are called \defnx{constexpr iterators}{constexpr!iterator} if
all operations provided to satisfy iterator category operations
...
\end{itemize}
\begin{note} For example, the types "pointer to \tcode{int}" and
\tcode{reverse_iterator<int*>} are constexpr iterators. \end{note}
