...
\begin{itemize}
\item
  all of \tcode{E}'s non-static data members shall be
  direct members of \tcode{E} or of the same base class of \tcode{E}, and
  shall be well-formed when named as \tcode{e.\placeholder{name}} in
  the context of the structured binding,
\item
